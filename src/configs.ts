  ...
  groups: [
    {
      ...
      args: [
        { visible: true, type: "file", id: "pretrained_model_name_or_path", title: lang("configs.base.model"), defaultValue: "", isOptional: false, enable: true, filters: [{ name: "Checkpoint", extensions: ["safetensors", "ckpt", "pt"] }], defaultPath: localStorage.getItem("sd-script-app_checkpoint_path") || "" },
        { visible: true, type: "file", id: "vae", title: lang("configs.base.vae"), defaultValue: "", isOptional: true, enable: false, filters: [{ name: "VAE", extensions: ["safetensors", "ckpt", "pt"] }], defaultPath: localStorage.getItem("sd-script-app_vae_path") || "" },
        { visible: true, type: "folder", id: "train_data_dir", title: lang("configs.base.train_data_dir"), defaultValue: "", isOptional: false, enable: true, defaultPath: localStorage.getItem("sd-script-app_dataset_path") || "" },
        { visible: true, type: "folder", id: "reg_data_dir", title: lang("configs.base.reg_data_dir"), defaultValue: "", isOptional: true, enable: false, defaultPath: localStorage.getItem("sd-script-app_dataset_path") || "" },
        { visible: true, type: "folder", id: "output_dir", title: lang("configs.base.output_dir"), defaultValue: "", isOptional: false, enable: true, defaultPath: localStorage.getItem("sd-script-app_output_path") || "" },
    ...
    },
    {
      ...
      args: [
        ...
        { visible: true, type: "folder", id: "logging_dir", title: lang("configs.log.logging_dir"), defaultValue: "", isOptional: true, enable: false, defaultPath: localStorage.getItem("sd-script-app_output_path") || "" },
      ],
    },
    {
    ...
    },
    {
      ...
      args: [
        ...
        { visible: true, type: "file", id: "network_weights", title: lang("configs.network.network_weights"), defaultValue: "", isOptional: true, enable: false, defaultPath: localStorage.getItem("sd-script-app_output_path") || "", filters: [{ name: "Checkpoint", extensions: ["safetensors", "ckpt", "pt"] }] },
    ...
    },
    {
      ...
      args: [
        ...
        { visible: true, type: "file", id: "sample_prompts", title: lang("configs.preview.sample_prompts"), defaultValue: "", isOptional: true, enable: false, defaultPath: localStorage.getItem("sd-script-app_dataset_path") || "", filters: [{ name: "Prompt", extensions: ["txt"] }] },
